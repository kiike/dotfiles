...
if &t_Co > 255
    ...
    hi Statement       ctermfg=187   ctermbg=256     cterm=none
    ...
    hi Title           ctermfg=7     ctermbg=256     cterm=bold
    hi Todo            ctermfg=108   ctermbg=256     cterm=bold
    hi Typedef         ctermfg=253   cterm=bold
    hi Type            ctermfg=187   cterm=bold
    hi Underlined      ctermfg=188   ctermbg=256     cterm=bold
    ...
    if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
        hi Normal ctermfg=188 ctermbg=256
